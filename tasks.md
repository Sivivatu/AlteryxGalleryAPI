...
- [x] **1.1** Rename package from alteryx_gallery_api to alteryx_server_py
    - Move `src/alteryx_gallery_api/` Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª `src/alteryx_server_py/`
...
- [x] **1.11** Update environment variable names (ALTERYX_*)
    - Rename `BASE_URL` Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª `ALTERYX_BASE_URL`
    - Rename `API_KEY` Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª `ALTERYX_CLIENT_ID`
    - Rename `API_SECRET` Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª `ALTERYX_CLIENT_SECRET`
    - Update `.env.example`
    - Update all tests
...
- [ ] **2.9** Integration tests against live server
    ...
    - Test workflow publish Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª job run Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª output retrieval flow
...
- [ ] **5.10** Create CHANGELOG.md
    - Document all changes from v0.1.0 Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├®Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£┬¬Ôö£├ÂÔö£├éÔö¼├║├ö├Â┬úÔö£├ª v0.2.0
