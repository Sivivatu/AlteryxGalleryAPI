...
- [x] **1.1** Rename package from alteryx_gallery_api to alteryx_server_py
    - Move `src/alteryx_gallery_api/` Ôö£├ÂÔö£├æÔö£├Ñ `src/alteryx_server_py/`
...
- [x] **1.11** Update environment variable names (ALTERYX_*)
    - Rename `BASE_URL` Ôö£├ÂÔö£├æÔö£├Ñ `ALTERYX_BASE_URL`
    - Rename `API_KEY` Ôö£├ÂÔö£├æÔö£├Ñ `ALTERYX_CLIENT_ID`
    - Rename `API_SECRET` Ôö£├ÂÔö£├æÔö£├Ñ `ALTERYX_CLIENT_SECRET`
    - Update `.env.example`
    - Update all tests
...
- [ ] **2.9** Integration tests against live server
    ...
    - Test workflow publish Ôö£├ÂÔö£├æÔö£├Ñ job run Ôö£├ÂÔö£├æÔö£├Ñ output retrieval flow
...
- [ ] **5.10** Create CHANGELOG.md
    - Document all changes from v0.1.0 Ôö£├ÂÔö£├æÔö£├Ñ v0.2.0
